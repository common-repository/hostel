<div class="wrap">
	...
	<div class="wrap wphostel-box postbox">
		<form class='wphostel-form' method="post">
			...
			<div align="center">
				<input type="submit" value="<?php _e('Save Reservation', 'wphostel')?>" class="button button-primary">			
				<?php if(!empty($booking->id)):?>
					<input type="button" value="<?php _e('Delete booking', 'wphostel');?>" onclick="wpHostelConfirmDelete(this.form);" class="button">
				<?php endif;?>
				<input type="button" value="<?php _e('Go Back', 'wphostel')?>" onclick="window.location='admin.php?page=wphostel_bookings&type=<?php echo esc_attr($_GET['type'])?>&offset=<?php echo (int)$_GET['offset']?>';" class="button">
			</div>
